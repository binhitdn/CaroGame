...
public class FriendList extends javax.swing.JFrame {
    ...
    public void startThread() {
        Thread thread = new Thread() {
            @Override
            public void run() {
                while (Client.friendList.isDisplayable() && !isClicked) {
                    try {
    ...
    public void requestUpdate() {
        try {
            Client.threadClient.write("view-friend-list,");
    ...
    private void friendTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_friendTableMouseClicked
        try {
            ...
            if (res == JOptionPane.YES_OPTION) {
                ...
                Client.openView("GAME_NOTICE", "Thách đấu", "Đang chờ phản hồi từ đối thủ");
                Client.threadClient.write("duel-request," + friend.getID());
            } else {
                isClicked = false;
                startThread();
            }
