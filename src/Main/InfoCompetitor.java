...
public class InfoCompetitor extends JFrame {
	...
	public InfoCompetitor(User competitor) {
		...
		panel.setBorder(new TitledBorder(new LineBorder(new Color(0, 0, 0), 1, true), "Th\u00F4ng Tin \u0110\u1ED1i Th\u1EE7", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(0, 0, 0)));
		...
		btnNewButton_1.setBackground(SystemColor.inactiveCaptionText);
		...
		lblNewLabel_4.setIcon(new ImageIcon("src/images/"+competitor.getAvatar()+".jpg"));
		...
		panel_3.setBorder(new TitledBorder(new LineBorder(new Color(0, 0, 0), 1, true), "Th\u00E0nh T\u00EDch", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(0, 0, 0)));
		panel_1.add(panel_3);
