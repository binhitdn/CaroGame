...
import Other.Point;
import Other.XOButton;


public class GameAI extends javax.swing.JFrame {
    ...
    public GameAI() {
        ...
        playerCurrentPosition.setIcon(new ImageIcon("X caro.jpg"));
        competitorCurrentPosition.setIcon(new ImageIcon("O caro.jpg"));
